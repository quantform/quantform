...
import * as withCommission from '@lib/with-commission';
import { Commission, d, makeTestModule } from '@quantform/core';

import * as withExchangeInfo from './api/with-exchange-info-request';
...
async function getFixtures() {
  ...
  return {
    ...
    givenInstrumentsReceived(timestamp: number, payload: any) {
      jest
        .spyOn(withExchangeInfo, 'withExchangeInfoRequest')
