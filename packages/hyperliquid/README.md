...
<p align="center">
  <a href="https://www.npmjs.com/package/@quantform/hyperliquid">
    <img src="https://img.shields.io/npm/v/@quantform/hyperliquid.svg?logo=npm&logoColor=fff&label=@quantform/hyperliquid&color=03D1EB" alt="quantform/hyperliquid on npm" />
  </a>&nbsp;
  <a href="LICENSE.md">
...
```
yarn add @quantform/hyperliquid
```
